...
$SMTPInfo.Credentials = New-Object System.Net.NetworkCredential('ashaansohal@gmail.com', 'Dadawgs21') #Email with which you want to send information
$ReportEmail = New-Object System.Net.Mail.MailMessage
$ReportEmail.From = 'ashaansohal@icloud.com' #Email in which you want to receice the information
$ReportEmail.To.Add('ashaansohal@icloud.com') #Email in which you want to receive the information
